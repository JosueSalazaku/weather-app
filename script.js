...
let geoData = {"results":[{"id":2797656,"name":"Ghent","latitude":51.05,"longitude":3.71667,"elevation":10.0,"feature_code":"PPL","country_code":"BE","admin1_id":3337388,"admin2_id":2789733,"admin3_id":2797655,"admin4_id":2797657,"timezone":"Europe/Brussels","population":231493,"postcodes":["9000"],"country_id":2802361,"country":"Belgium","admin1":"Flanders","admin2":"East Flanders","admin3":"Arrondissement of Ghent","admin4":"Gent"}],"generationtime_ms":0.2220869};
let geoUrl;
...
async function getGeoData(location) {
    ...
    const geoUrl = "https://geocoding-api.open-meteo.com/v1/search?name=ghent&count=1&language=en&format=json"
    try {
...
async function fetchWeatherData(location) {
    const apiUrl = "https://api.open-meteo.com/v1/forecast?latitude=52.52&longitude=13.41&current=temperature_2m,is_day,rain&hourly=temperature_2m&daily=weather_code,temperature_2m_max,sunrise&timezone=Europe%2FLondon"
